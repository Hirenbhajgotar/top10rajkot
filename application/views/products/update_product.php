...
<div class="page-inner">
    <div class="page-title">
        <h3 class="breadcrumb-header">Update Product</h3>
    </div>
    <div id="main-wrapper">
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-white">
                    <div class="panel-body">
                        <?php echo form_open_multipart("Products/updateProductData/{$product['id']}", ['id' => 'validate_product']); ?>
                        ...
                        <div class="form-group col-md-6">
                            <label class="col-form-label">Parent category name</label>
                            <div class="">
                                <?php
                        ...
                        <div class="form-group">
                            <div class=" col-sm-10">
                                <button type="submit" name="submit" class="btn btn-primary"><i class='fa fa-edit'></i> Update Product</button>
