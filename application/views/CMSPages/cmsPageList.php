        ...
        <div class="card">
            <div class="card-block">
                <div class="float-right">
                    <a href="<?php echo base_url(); ?>CmsPage/addCmsPage" class="fa fa-plus-circle" aria-hidden="true" style="height: 20px;">Add</a>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if ($data['status'] == 1) { ?>
                                                    <a class="label label-inverse-primary enable" href='<?php echo base_url(); ?>users/enable/<?php echo $data['id']; ?>?table=<?php echo base64_encode('tr_cms_page'); ?>'>Enabled</a>
                                                <?php } else { ?>
                                                    <a class="label label-inverse-warning desable" href='<?php echo base_url(); ?>users/desable/<?php echo $data['id']; ?>?table=<?php echo base64_encode('tr_cms_page'); ?>'>Desabled</a>
                                                <?php } ?>
                                            </td>
                                            <td>
                                                <a class="label label-inverse-info" href='<?php echo base_url(); ?>CmsPage/updateCms/<?php echo $data['id']; ?>'>Edit</a>
                                            </td>
                                        </tr>
                                    <?php }
                                } else { ?>
