            ...
            <div class="col-md-12">
                <div class="panel panel-white">
                    <div class="panel-heading clearfix" style="margin-bottom: 20px">
                        <div class="right">
                            <a href="<?php echo base_url("Banner/addBanner"); ?>" class="btn btn-success size" aria-hidden="true"><i class="fa fa-plus"></i> &nbsp Add Banner</a>
                                ...
                                <tbody>
                                    <?php if (!empty($banners)) {
                                        ...
                                        foreach ($banners as $banner) { ?>
                                            <tr>
                                                <td><input type="checkbox" class="checkbox" name="chk[]" id="chkd" value="<?php echo $banner->id; ?>" /></td>
                                                <td><?php echo $i; ?></td>
                                                <td>
                                                    <?php if ($banner->image) { ?>
