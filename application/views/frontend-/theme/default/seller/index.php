                    ...
                    <div class="col-sm-12">
                        ...
                        ?>
                            <div class="row listing-row">
                                <div class="col-sm-5">
                                    <!-- <a href="#"><img src="<?= base_url("application/views/frontend/theme/default/assets/images/img1.jpg") ?>" alt="" class="img-responsive"></a> -->
                                    <a href="#"><img src="<?= base_url("assets/images/seller_home_content/$item->logo_image") ?>" alt="" class="img-responsive"></a>
                                </div>
                                <div class="col-sm-7">
                                    <h4><a href="#"><?= $item->firstname . ' ' . $item->lastname ?></a></h4>
                                    <p>
                                        <?= $item->description ?>
                                    </p>
                                </div>
