                    ...
                    <div class="panel-body" id="dataList">
                        ...
                        <div class="table-responsive dataTables_wrapper " style="width: 100%;">
                            ...
                            <table id="" class="display table">
                                ...
                                <tbody>
                                    <?php if (!empty($banners_info)) {
                                        $i = 1;
                                        foreach ($banners_info as $banner) { ?>
                                            <tr>
                                                <td><input type="checkbox" class="checkbox" name="chk[]" id="chkd" value="<?php echo $banner->banner_id; ?>" /></td>
                                                <td><?php echo $i ?></td>
                                                ...
                                                <td>
                                                    <a class="btn btn-info btn-rounded right" href='<?php echo base_url("Buyer/updateBuyer/{$banner->banner_id}"); ?>'>
