            ...
            <div class="page-header">
                ...
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="#!">Sellers</a>
                        </li>
                        <li class="breadcrumb-item"><a href="#!">Add Seller</a>
                        </li>
                    </ul>
                </div>
            </div>
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-block">
                             ...
                             <div class="col-sm-8">
                               <?php echo form_open_multipart('administrator/add_seller', 'id="seller_form"'); ?>
									...
									<div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                      <input type="password" name="confirmpasswords" class="form-control" placeholder="Confirm Password">
                                        </div>
                                    </div>
