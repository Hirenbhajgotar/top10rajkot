...
<div class="main-menu">
    ...
    <div class="main-menu-content">
        <ul class="main-navigation">
            ...
            <li class="nav-item">
                <a href="<?php echo base_url(); ?>usersgroup/usersgroup">
                    <i class="ti-layout"></i>
            ...
            <li class="nav-item">
                <a href="<?php echo base_url(); ?>administrator/seller/seller">
                    <i class="ti-layout"></i>
                    <span>Seller</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="<?php echo base_url(); ?>Buyer/buyerList">
                    <i class="ti-layout"></i>
                    <span>Buyer</span>
                </a>
            </li>
            <li class="nav-item">
                <!-- <a href="<?php echo base_url(); ?>administrator/product-categories">
                        <i class="ti-layout"></i>
                        <span>Category</span>
                    </a>	 -->
                <a href="<?php echo base_url(); ?>Category/categoryList">
                    <i class="ti-layout"></i>
                    <span>Category</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a href="<?= base_url("Products/productList") ?>">
            ...
            <li class="nav-item">
                <a href="<?php echo base_url(); ?>CmsPage/CmsPageList">
                    <i class="ti-layout"></i>
                    <span>CMS Pages</span>
                </a>
            </li>
